 ...
 * ve son parça, aralarında Dust eğik çizgi. Flare yok. Döngü görünmesin
...
export default function SparkTicker({ items }: SparkTickerProps) {
  ...
  return (
    <Marquee className="overflow-hidden border-t border-inkrule bg-ink py-4 font-mono text-[12px] leading-[normal] font-medium tracking-[0.1em] text-paper uppercase min-[900px]:py-[22px] min-[900px]:text-[14px]">
