import StickyStack from "@/components/effects/StickyStack";
  ...
  return (
    <section className="border-t border-bronze/45 bg-navy px-7 pt-[104px] pb-[120px]">
      <div className="mx-auto max-w-[1080px]">
        ...
        <StickyStack
          className="flex flex-col gap-[26px] pb-2"
          cardClassName="rounded-[20px] backdrop-blur-[18px]"
          cardStyle={{
        ...
        >
          {points.map((point) => (
            ...
            // yok (sabit 132px), bilinçli mobil sapma: metne daha çok yer
            // açmak için. sm: ve üstü dc.html ile birebir aynı.
            <div
              key={point.order}
              className="grid grid-cols-[85px_1fr] items-start gap-7 px-10 pt-9.5 pb-10 sm:grid-cols-[132px_1fr]"
            >
