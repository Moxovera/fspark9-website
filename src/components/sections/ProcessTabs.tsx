  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] items-start gap-14">
      ...
      <div className="col-span-2 flex min-h-[260px] min-w-0 flex-col gap-[26px]">
        ...
        <BookingCta className="self-start rounded-[30px] bg-bronze px-[26px] py-[15px] text-[15px] font-medium text-ivory transition-[transform,box-shadow] duration-[250ms] ease-out hover:-translate-y-0.5 hover:shadow-[0_12px_34px_rgba(166,124,61,0.38)]">
          {ctaLabel}
        </BookingCta>
      </div>
    </div>
